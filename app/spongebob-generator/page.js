    ...
    <div className={`${spongebobFont.variable} font-sans`}>
      ...
      <main className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-4 p-4">
        ...
        <section className="flex flex-col items-center gap-3 rounded-2xl border border-slate-800 bg-gradient-to-b from-[#0b1222] to-[#0b0f1d] p-4 shadow-2xl">
          ...
          <div className="w-full">
            ...
            <input
              ...
              className="mt-1.5 w-full rounded-lg border border-[#243042] bg-[#0d1b2a] px-3 py-2.5 text-custom-text file:mr-3 file:border-0 file:bg-slate-700 file:rounded-md file:py-1 file:px-3 file:text-xs file:font-semibold file:text-custom-text"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 w-full">
            <div>
              <label className="text-xs text-custom-muted">Aspect Ratio</label>
              <select
                value={aspectRatio}
                onChange={(e) => setAspectRatio(e.target.value)}
                className="mt-1.5 w-full rounded-lg border border-[#243042] bg-[#0d1b2a] px-3 py-2.5 text-custom-text"
              >
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 mt-2 w-full">
            <button
              ...
              className="px-4 py-2.5 rounded-lg bg-gradient-to-b from-blue-600 to-blue-800 border border-blue-700 text-white font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {buttonText}
            </button>
        ...
        <section className="flex flex-col items-center rounded-2xl border border-slate-800 bg-gradient-to-b from-[#0b1222] to-[#0b0f1d] p-4 shadow-2xl">
          <div className="flex items-center justify-center w-full h-[clamp(360px,70vh,720px)] overflow-hidden">
            <div
      ...
      <section className="mx-4 mb-4 rounded-2xl border border-slate-800 bg-gradient-to-b from-[#0b1222] to-[#0b0f1d] p-4 shadow-2xl">
        <h2 className="mb-2 text-sm font-semibold text-custom-muted">
          Background presets (click to apply)
        </h2>
